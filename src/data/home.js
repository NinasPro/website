...
export default ({
    ...
    "es":{
        ...
        projectsHome:[
            {'title':'Iniciativa Empodera','type':'is-danger','image':'laschicaspueden.jpg', 'path':'/empodera/','description':'Curso Anual de Programación Competitiva en C++'},
            {'title':'Iniciativa Inspira', 'type':'is-info', 'image':'lamarr.jpg', 'path':'/inspira/', 'description':'Charla de Mujeres Pro y creación de Role Models'},
            {'title':'Iniciativa Incentiva', 'type':'is-warning' ,'image':'ninastic.jpg', 'path':'/incentiva/','description':'Talleres Introductorios de Programación'},
            {'title':'Iniciativa Potencia', 'type':'is-success', 'image':'sororidad.jpg', 'path':'/potencia/', 'description':'Cursos Avanzados de Programación'},
        ],
        information:[
            {'type':'left', 'image':'inspired.jpg', 'text':'Si tienes menos de 18 años. Diviértete, aprende y conecta con otras Niñas Pro como tú.', 'titulo':'¡Participa!', 'boton':'Ver proximas actividades', 'Path':'/eventos/'},
            {'type':'right', 'image':'django-girls.jpg', 'text':'Si quieres ayudarnos. Participa del voluntariado o ayúdanos a llegar a mas niñas a traves de donaciones.', 'titulo':'¡Involúcrate!', 'boton':'Mas información' ,'Path':'/voluntariado/'},
        ],
        news:[
            {'title':'Titulo 1', 'type':'is-info', 'text':'Ver noticia completa', 'path':'/enconstruccion/'},
            {'title':'Titulo 2', 'type':'is-info', 'text':'Ver noticia completa', 'path':'/enconstruccion/'},
